<template>
  <div class="mx-5 sm:mx-0 flex flex-col space-y-5 max-w-xl">
    <img
      alt="Profile Picture"
      loading="lazy"
      width="60"
    ...
    <div class="mt-6 flex gap-6">
      <a
        href="https://twitter.com/zz4svn"
        target="_blank"
        rel="noreferrer noopener"
        ><svg
          viewBox="0 0 24 24"
          aria-hidden="true"
          class="h-6 w-6 hover:scale-105 transition-all"
        >
          <path
      ...
      ><a
        ...
        >
          ...
          ></path></svg></a
      ><a
        href="https://linkedin.com/in/adavize-hassan"
        target="_blank"
        rel="noreferrer noopener"
        ><svg
          viewBox="0 0 24 24"
