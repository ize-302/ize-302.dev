    ...
    >
      ...
      >
        <p
          v-if="item.name"
          :class="`${
            item.type == 'banner' ? 'text-md md:text-2xl' : 'text-md'
          }`"
        ...
        <div class="text-sm mt-2 flex items-center flex-wrap gap-1">
          <span
            class="bg-zinc-100 text-zinc-600 rounded-md py-0.5 px-1.5"
      ...
      >
        <img
          width="100%"
          class="absolute border top-4 md:top-0 w-full rounded-md"
          :alt="item.name"
...
const personalprojects = [
  {
    name: "⛽ gofuel.app",
    type: "banner",
    description: "Find the best fuel prices near you",
    link: {
      name: "Visit",
      url: "https://gofuel.app",
    },
    thumbnail: "gofuel.png",
    tags: ["TypeScript", "Nextjs", "Nestjs", "Postgresql", "Google places API"],
  },
  {
  ...
  },
  {
    name: "😎 gitmo",
    description:
      "Add appropriate emoji to your commit messages based on conventional commits specification",
    icon: "mood",
    link: {
      name: "Source code",
